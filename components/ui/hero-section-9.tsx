...
const HeroSection = ({ title, subtitle, actions, stats, images, className }: HeroSectionProps) => {
  return (
    <section className={cn('w-full overflow-hidden bg-transparent py-12 sm:py-24', className)}>
      <div className="mx-auto max-w-7xl grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-8 px-4 sm:px-6 lg:px-8">
          ...
          <motion.div className="mt-8 flex flex-wrap justify-center gap-4 lg:justify-start" variants={itemVariants}>
            {actions.map((action, index) => (
              <Button
                ...
                size="lg"
                className={cn(
                  action.variant === 'default' && 'bg-black text-white hover:bg-black/90',
                  action.className
                )}
              >
        ...
        >
          ...
          >
            <img src={images[0]} alt="Artisan au travail" className="h-full w-full rounded-xl object-cover" />
          </motion.div>
          <motion.div
            ...
            variants={imageVariants}
          >
            <img src={images[1]} alt="Gestion d'entreprise" className="h-full w-full rounded-xl object-cover" />
          </motion.div>
          <motion.div
            ...
            variants={imageVariants}
          >
            <img src={images[2]} alt="Organisation professionnelle" className="h-full w-full rounded-xl object-cover" />
          </motion.div>
        </motion.div>
      </div>
    </section>
